...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  // Review
  creating: { label: '创建中', className: 'bg-blue-50 text-blue-700 border-blue-200' },
  importing: { label: '导入中', className: 'bg-blue-50 text-blue-700 border-blue-200' },
  ready: { label: '待审核', className: 'bg-gray-50 text-gray-700 border-gray-200' },
  in_review: { label: '审核中', className: 'bg-amber-50 text-amber-700 border-amber-200' },
  exporting: { label: '发布中', className: 'bg-blue-50 text-blue-700 border-blue-200' },
};
