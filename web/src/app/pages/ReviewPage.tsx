...
export default function ReviewPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const result = await listReviewSessions({ search, page, pageSize: 20 });
        ...
        <table className="w-full min-w-[980px] text-sm">
          ...
          <tbody>
            ...
            {!loading && !error && sessions.map(session => {
              const pct = session.totalTasks > 0
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-2.5">
                    {session.labelStudioProjectId !== null ? <div className="flex items-center gap-1">
